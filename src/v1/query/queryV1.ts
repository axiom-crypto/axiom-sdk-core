...
export class QueryV1 extends Query {
  /**
  ...
  new(...args: any) {
    throw new Error("Method not implemented for QueryV1. Please use `axiom.newQueryBuilder()` instead");
  }
  ...
  async getResponseTreeForKeccakQueryResponse(
    ...
    let qb = new QueryBuilderV1(this.config);
