...
describe("Templates", () => {
  ...
  test("getMappingValues", async () => {
    ...
    const dataQuery = getMappingValues(15537394, WETH_ADDR, "3", "address", wethHolders);
  ...
  test("getMappingValues appended to another getMappingValues", async () => {
    const wethHolders = [
      "0xf04a5cc80b1e94c69b48f5ee68a08cd2f09a7c3e",
      "0x2f0b23f53734252bda2277357e97e1517d6b042a",
      "0x030ba81f1c18d280636f32af80b9aad02cf0854e",
    ...
    const dataQuery2 = getMappingValues(16000000, MATIC_ADDR, "3", "address", maticHolders);
